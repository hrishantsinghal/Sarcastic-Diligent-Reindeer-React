...
const Careers = (props) => {
  return (
    <div className="careers-container">
      <Helmet>
        <title>Careers - Bihar Job Connect</title>
        <meta property="og:title" content="Careers - Bihar Job Connect" />
      </Helmet>
      <header data-thq="thq-navbar" className="careers-navbar-interactive">
        <span className="careers-logo">Bihar job connect</span>
        <div data-thq="thq-navbar-nav" className="careers-desktop-menu">
          <nav className="careers-links">
            <Link to="/" className="careers-nav1">
              About
            </Link>
            <Link to="/careers" className="careers-nav2">
              Careers
            </Link>
          </nav>
        ...
        <div data-thq="thq-burger-menu" className="careers-burger-menu">
          <svg viewBox="0 0 1024 1024" className="careers-icon">
        ...
        <div data-thq="thq-mobile-menu" className="careers-mobile-menu">
          <div className="careers-nav">
            <div className="careers-top">
              <span className="careers-logo1">Bihar Job Connect</span>
              <div data-thq="thq-close-menu" className="careers-close-menu">
                <svg viewBox="0 0 1024 1024" className="careers-icon02">
                  <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                </svg>
              </div>
            </div>
            <nav className="careers-links1">
              <Link to="/" className="careers-nav11">
                About
              </Link>
              <Link to="/careers" className="careers-nav21">
                Careers
              </Link>
            </nav>
            <div className="careers-buttons1"></div>
          </div>
          <div>
            <svg
              viewBox="0 0 950.8571428571428 1024"
              className="careers-icon04"
            >
